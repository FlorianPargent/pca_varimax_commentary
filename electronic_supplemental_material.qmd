...
In their paper “Vintage factor analysis with varimax performs statistical inference”, Rohe and Zeng (R&Z) demonstrate the usefulness of principal component analysis with varimax rotation (PCA+VR) – a combination they call vintage factor analysis.
...
In our comment “New Insights into PCA + Varimax for Psychological Researchers”, we briefly discuss what these results mean for psychological research and show that the suggested diagnostics of “radial streaks” might be difficult for typical psychological data.
This document presents the data analysis that is discussed in our comment. 

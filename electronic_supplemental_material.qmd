...
Rohe & Zeng (R&Z; @rohe2022vintage) proof what many psychologists have suspected but is dismissed by the literature: Principal component analysis in combination with Varimax rotation (PCA+VM\; @kaiser1958varimax) *does* estimate factor scores in latent variable models.
...
Interestingly, R&Z hint that in their semi-parametric factor model, their extension of PCA+VM might be used to also estimate correlated factors.
...
While R&Z’s results are highly relevant for widespread applications of PCA+VM, details might differ in psychology which could profit from better understanding of the $B$ matrix, and how to estimate oblique factors and loadings.

...
author:
  - name: Florian Pargent, LMU Munich
  - name: David Goretzko, Leipzig University
  - name: Timo von Oertzen, Bundeswehr University Munich
format: pdf
...
It is also a cautionary example how imputation of missing values in combination with inappropriate data processing seemingly produce streaks in $\hat{Z}$ that belong to uninterpretable components.
